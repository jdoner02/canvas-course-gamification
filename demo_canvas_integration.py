...
class CanvasIntegrationDemo:
        ...
        return {
            ...
            "submissions": [
                ...
                },
                {
                    ...
                    "user_id": 2002,
                    "score": 20,
                    "submitted_at": "2025-07-01T11:30:00Z",
                },
                {
                    "assignment_id": 1002,
                    "user_id": 2001,
                    "score": 28,
                    "submitted_at": "2025-07-02T14:15:00Z",
                },
            ],
        }
    ...
    def demo_skill_tree_mapping(self):
        ...
        student_progress = {
            ...
            2002: {
                "total_xp": 145,
                "completed_skills": ["vector_operations", "linear_combinations"],
            },
    ...
    def demo_badge_system(self):
        ...
        student_data = {
            ...
            2002: {
                "xp": 145,
                "skills": ["vector_operations", "linear_combinations"],
                "speed_bonus": True,
            },
