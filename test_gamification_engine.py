...
from gamification_engine.core.player_profile import PlayerProfileManager, MathematicalSpecialization, SkillCategory
from gamification_engine.pets.companion_system import MathPetSystem, PetType, PetPersonality
from gamification_engine.social.guild_system import GuildManager, Guild, StudyParty
from gamification_engine.social.mentorship_system import PeerTeachingEngine, MentorshipChain
from gamification_engine.social.competition_system import PvPBattleEngine, TournamentManager
...
class GamificationEngine:
    ...
    def onboard_student(self, student_id: str, canvas_user_id: str = None,
        ...
        player_class = preferences.get('player_class', MathematicalSpecialization.ENGINEER) if preferences else MathematicalSpecialization.ENGINEER
    ...
    def award_xp(self, student_id: str, base_xp: int, source: str,
        ...
        if profile.rpg_active:
            ...
            if rpg_player:
                if source == "problem_solving" and rpg_player['specialization'] == MathematicalSpecialization.ENGINEER:
                    total_multiplier += 0.2  # Engineers get bonus for problem solving
                elif source == "peer_teaching" and rpg_player['specialization'] == MathematicalSpecialization.PURE_MATHEMATICIAN:
    ...
    def complete_learning_activity(self, student_id: str, activity_type: str,
        ...
        if profile.rpg_active:
            ...
            if activity_type in ["matrix_operations", "determinant_calculation"]:
                self.rpg_system.award_skill_experience(student_id, SkillCategory.MATRIX_MASTERY, skill_xp)
            elif activity_type in ["vector_operations", "dot_product"]:
                self.rpg_system.award_skill_experience(student_id, SkillCategory.VECTOR_OPERATIONS, skill_xp)
