...
class DrLynchYouTubeManager:
    ...
    def __init__(self, api_key: str = None):
        ...
        self.skill_keywords = {
            "vector_introduction": ["vector", "magnitude", "direction", "arrow", "ordered pair"],
            "vector_operations": ["vector addition", "scalar multiplication", "components"],
            "vector_products": ["dot product", "cross product", "perpendicular", "angle"],
            "linear_equations": ["system", "gaussian elimination", "augmented matrix"],
            "matrix_basics": ["matrix", "entries", "dimensions", "rows", "columns"],
            "matrix_operations": ["matrix addition", "matrix multiplication", "inverse", "determinant"],
            ...
            "linear_transformations": ["transformation", "linear map", "kernel", "image"]
        }
    ...
    def _extract_keywords(self, transcript: str, title: str) -> List[str]:
        ...
        math_terms = [
            ...
            "linear", "algebra", "system", "equation", "transformation",
            "dot product", "cross product", "gaussian", "elimination",
            "inverse", "transpose", "dimension", "basis", "subspace"
        ]
    ...
    def search_content(self, query: str, limit: int = 5) -> List[Dict[str, Any]]:
        ...
        # Transcript search
        for video_id, video in self.videos.items():
            if query_lower in video.transcript.lower() or query_lower in video.title.lower():
...
async def main():
    ...
    for query in search_queries:
        ...
        for result in results:
            print(f"   📹 {result['title']} (relevance: {result['relevance_score']:.1f})")
