...
class CanvasIntegrationWizard:
    ...
    def collect_canvas_credentials(self):
        ...
        self.canvas_info = {"base_url": canvas_url, "api_token": api_token}
    ...
    def select_course(self):
        ...
        try:
            ...
            for i, course in enumerate(courses):
                ...
                print(
                    f"   {i+1}. {course.get('name')} (ID: {course.get('id')}, Students: {enrollment_count})"
                )
    ...
    def configure_gamification_settings(self):
        ...
        self.config = {
            ...
            "gamification": {
                ...
                "theme": {"name": skill_tree_theme, "style": "academic_adventure"},
            },
            "privacy": {
    ...
    def run_final_test(self):
        ...
        try:
            ...
            assignments_url = (
                f"{self.canvas_info['base_url']}/api/v1/courses/{course_id}/assignments"
            )
