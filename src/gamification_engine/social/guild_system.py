...
class StudyParty:
    ...
    def remove_member(self, student_id: str) -> bool:
        ...
        if student_id in self.members:
            ...
            logger.info(f"Removed student {student_id} from study party {self.party_id}")
            return True
        return False
...
class Guild:
    ...
    def promote_to_officer(self, student_id: str) -> bool:
        ...
        if student_id in self.members and student_id not in self.officers:
            ...
            logger.info(f"Promoted student {student_id} to officer in guild {self.name}")
            return True
        return False
...
class GuildManager:
    ...
    def create_guild(self, name: str, description: str, leader_id: str, 
                    motto: str = None, color: str = None) -> str:
        """Create a new guild"""
    ...
    def create_study_party(self, leader_id: str, party_type: StudyPartyType = StudyPartyType.HOMEWORK_GRIND) -> str:
...
if __name__ == "__main__":
    ...
    # Create study party
    party_id = guild_manager.create_study_party("student_alice", StudyPartyType.EXAM_PREP)
    ...
    if party.current_session:
        ...
        party.current_session.concepts_mastered = ["Matrix Multiplication", "Determinants"]
    ...
    print(f"🏆 Guild Leaderboard: {[(name, guild.guild_xp) for name, guild in leaderboard]}")
